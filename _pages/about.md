...
저는 최근 Spring Boot, Airflow, GCS, RDB 등을 활용해  
API 설계부터 데이터 파이프라인 까지 실서비스 전반을 설계하고 운영해 온 백엔드 개발자입니다.

개발할 때, 주로 고민하는 내용은 다음과 같습니다. 🤔

**1. “어떻게 하면 사용자에게 더 신뢰도 높은 기능을 안정적으로 제공할 수 있을까?”**  
**2. “어떻게 하면 대규모 데이터를 정확한 시간에 더 빠르고 안정적으로 전송할 수 있을까?”**  
**3. “어떻게 하면 내가 설계한 구조와 코드가 확장성 있을까?”**


그래서 저는 안정적인 운영 자동화, 고성능 구현, 효율적인 구조 설계를 개발의 핵심 가치로 삼고 있어요.
...
Spring Boot 기반 마이데이터 보험업권 API 개발과
Express, Nest.js 기반 보험 진단·추천 엔진을 맡아 운영한 경험이 있습니다 !
...
이외에도 비즈니스 캠페인에 필요한 통계치 추출 자동화를 위해 Airflow 스케줄링 개발을 담당하고 있으며,
GCP Cloud Run 자동화 배포 등 서비스 운영과 안정화에 필요한 백엔드 전반의 기술적 요소들을 실무에 적용해 왔습니다.
